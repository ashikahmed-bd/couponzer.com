...
defineProps({
  ...
  image: {
    type: String,
    default: "/images/top-stores-icon-2.png",
  },
  title: {
    type: String,
    default: "Amazon Trade Groups",
  },
  expiry: {
    type: String,
    default: "25 Nov, 24",
  ...
  code: {
    type: String,
    default: "FGFKG6589895AF",
  },
  storeLink: {
    type: String,
    default: "/stores-style-3",
  },
});
...
<template>
  <div
    class="group flex flex-col overflow-hidden rounded-3xl border border-gray-200 bg-white p-2 transition duration-300 hover:-translate-y-1"
  >
    <div
      class="flex w-full items-center justify-center overflow-hidden rounded-2xl bg-gray-50"
    >
      <NuxtImg
        :src="image"
        :alt="title"
    ...
    <div class="grid gap-4 p-2.5">
      <NuxtLink :to="storeLink" class="block">
        <h4
          class="text-2xl font-bold leading-snug text-gray-900 transition duration-300 group-hover:text-orange-600"
        >
          {{ title }}
        </h4>
      </NuxtLink>
      ...
      <div
        class="flex items-center gap-2 rounded-md border border-orange-200 bg-orange-50 p-1"
      >
        <div
          class="flex items-center justify-center rounded-lg bg-white shadow-sm p-1"
        >
          <img src="/images/fav.png" alt="fav" class="h-5 w-5 object-contain" />
        </div>
        <span class="whitespace-nowrap text-xs font-medium text-orange-600">
          Upto 58% Voucher Rewards
        </span>
      </div>

      <UModal
        title="30% Off All Beauty Products"
        :ui="{
      ...
      >
        <button
          @click="handleClick"
          class="relative w-full flex items-center justify-between rounded-full border border-dashed border-orange-400 py-3"
        >
          <span
        ...
        <template #body>
          <div class="flex flex-col items-center gap-3">
            ...
            <p class="text-center text-sm font-medium text-gray-500 py-2">
              Continue to
              <a
                href="#"
          ...
          <div class="grid gap-2 border-y border-gray-200 p-4">
            <p class="text-sm leading-7 text-gray-600">
              <span class="font-semibold text-gray-900">Offer's Details:</span>
              Click here to shop at Legoland and get Up to $30 Off California
              Brick-or-Treat Tickets. No code required for this offer. Your
              shopping cart will receive discounts only if the deal is used at
              legoland.com before 27 Oct 2024.
            </p>
            ...
            <div>
              ...
              <ul class="grid gap-2 pl-5 text-sm text-gray-600">
                <li class="list-disc">Exclusions may apply.</li>
                <li class="list-disc">
                ...
                <li class="list-disc">
                  Discount deals can be limited by the seller at any time.
                </li>
                <li class="list-disc">
