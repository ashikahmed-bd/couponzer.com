      ...
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="relative hidden flex-1 max-w-xs lg:block">
          ...
          <div v-if="showDropdown"
            class="absolute top-full mt-2 w-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
            <a v-for="item in results" :key="item.id" :href="`/store/${item.slug}`"
              class="flex items-center justify-between gap-2 px-4 py-3 transition hover:bg-slate-50 rounded-lg">
              ...
              <div class="h-10 w-auto shrink-0 overflow-hidden  bg-white">
